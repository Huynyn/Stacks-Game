 ...
 * 
 * this is for a easy difficulty slider
 * 
 *
 * @author (Huy Nguyen)
...
public class EasySlider extends Slider
{
    ...
    private static final short STARTING_DURATION = 5000;  //how long it takes the slider to move across the first time it's placed.  K
    private static final short FASTEST_DURATION = 3000; //the fastest it can take the slider to move across the screen on it's placed
